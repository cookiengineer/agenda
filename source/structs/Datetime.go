...
func (datetime *Datetime) String() string {
	...
	buffer.WriteString(utils.FormatUint(datetime.Year, 4))
	buffer.WriteString("-")
	buffer.WriteString(utils.FormatUint(datetime.Month, 2))
	buffer.WriteString("-")
	buffer.WriteString(utils.FormatUint(datetime.Day, 2))
	buffer.WriteString(" ")
	buffer.WriteString(utils.FormatUint(datetime.Hour, 2))
	buffer.WriteString(":")
	buffer.WriteString(utils.FormatUint(datetime.Minute, 2))
	buffer.WriteString(":")
	buffer.WriteString(utils.FormatUint(datetime.Second, 2))
